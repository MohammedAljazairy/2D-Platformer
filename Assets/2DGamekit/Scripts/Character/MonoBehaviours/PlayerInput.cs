...
namespace Gamekit2D
{
    public class PlayerInput : InputComponent, IDataPersister
    {
        ...
        public InputButton MeleeAttack = new InputButton(KeyCode.Mouse0,MouseButton.Left ,XboxControllerButtons.X);
        public InputButton RangedAttack = new InputButton(KeyCode.Mouse2,MouseButton.Right,XboxControllerButtons.B);
